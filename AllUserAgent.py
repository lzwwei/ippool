...
class UserAgentError(Exception):
    def __str__(self):
        return repr('UserAgent Selecter Error!!!')
class ReqMethodError(UserAgentError):
    def __str__(self):
        return repr('Request Method is wrong!!!')

class UserAgentSelecter(object):
    '''
    随机User-Agent
    '''
    def __init__(self):
    ...
    def Selecter(self,reqmethod):
        if reqmethod == 'Android':
            useragentlist = self.Android_USER_AGENT
        elif reqmethod == 'Apple':
            useragentlist = self.iPhone_USER_AGENT
        elif reqmethod == 'PC':
            useragentlist = self.MY_USER_AGENT
        else:
            raise ReqMethodError
